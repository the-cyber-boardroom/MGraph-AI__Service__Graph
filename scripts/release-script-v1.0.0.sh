...
echo "v1.0.0" > mgraph_ai_service_graph/version
...
git diff mgraph_ai_service_graph/version README.md pyproject.toml

# Commit changes
echo "💾 Committing changes..."
git add mgraph_ai_service_graph/version README.md pyproject.toml
...
echo "   1. Go to https://github.com/the-cyber-boardroom/MGraph-AI__Service__Graph/releases"
