...
class test_Schema__Graph__Add_Node__Response(TestCase):
    ...
    def test__with_success_false(self):                                                     # Test failed node creation
    ...
    def test__serialization_round_trip__minimal(self):                                      # Test JSON round-trip with minimal data
        with Schema__Graph__Add_Node__Response(cached  = False,
                                               success = False) as original:
            json_data = original.json()

            with Schema__Graph__Add_Node__Response.from_json(json_data) as restored:
