...
class test_Schema__Graph__Neighbors__Request(TestCase):
    ...
    def test__init__(self):                                                                 # Test auto-initialization
        with Schema__Graph__Neighbors__Request() as _:
            ...
            assert type(_.node_id)   is Node_Id                                              # Node to find neighbors for
    ...
    def test__with_graph_ref__graph_id(self):                                               # Test with graph_ref containing graph_id
        ...
        with Schema__Graph__Neighbors__Request(graph_ref = graph_ref,
    ...
    def test__serialization_round_trip__minimal(self):                                      # Test JSON round-trip with minimal data
        with Schema__Graph__Neighbors__Request() as original:
            json_data = original.json()

            with Schema__Graph__Neighbors__Request.from_json(json_data) as restored:
    ...
    def test__default_namespace(self):                                                      # Test default namespace from Schema__Graph__Ref
        ...
        with Schema__Graph__Neighbors__Request(graph_ref = graph_ref) as _:
