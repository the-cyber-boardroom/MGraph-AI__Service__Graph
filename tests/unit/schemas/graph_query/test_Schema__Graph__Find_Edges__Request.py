...
class test_Schema__Graph__Find_Edges__Request(TestCase):
    ...
    def test__init__(self):                                                                 # Test auto-initialization
        with Schema__Graph__Find_Edges__Request() as _:
            ...
            assert type(_.graph_ref)  is Schema__Graph__Ref                                 # Optional graph_ref
            assert _.edge_type        == ''                                                 # Optional filter
    ...
    def test__with_graph_ref__graph_id(self):                                               # Test with graph_ref containing graph_id
        ...
        with Schema__Graph__Find_Edges__Request(graph_ref = graph_ref,
    ...
    def test__without_edge_type_filter(self):                                               # Test finding all edges (no type filter)
        graph_ref = Schema__Graph__Ref(graph_id = Graph_Id(Obj_Id()))

        with Schema__Graph__Find_Edges__Request(graph_ref = graph_ref) as _:
            assert _.edge_type == ''                                                        # No filter - find all
    ...
    def test__serialization_round_trip__minimal(self):                                      # Test JSON round-trip with minimal data
        with Schema__Graph__Find_Edges__Request() as original:
            json_data = original.json()

            with Schema__Graph__Find_Edges__Request.from_json(json_data) as restored:
    ...
    def test__serialization_round_trip__complete(self):                                     # Test JSON round-trip with all fields
        ...
        with Schema__Graph__Find_Edges__Request(graph_ref = graph_ref,
                                                edge_type = edge_type) as original:
            json_data = original.json()
    ...
    def test__edge_type_auto_conversion(self):                                              # Test edge_type auto-converts from str
        graph_ref = Schema__Graph__Ref(graph_id = Graph_Id(Obj_Id()))

        with Schema__Graph__Find_Edges__Request(graph_ref = graph_ref     ,
                                                edge_type = 'CUSTOM_EDGE') as _:
            assert type(_.edge_type) is Safe_Str__Id
            assert _.edge_type       == 'CUSTOM_EDGE'